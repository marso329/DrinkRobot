...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StartScreen::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartScreen::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject StartScreen::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_StartScreen.data,
