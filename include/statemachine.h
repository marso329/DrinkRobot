...
enum Widgets { frontpage, mainpage, adminpage,loginpage,drinkpage,adduserpage,addingrediantpage,setlevelspage,adddrinkpage,settemppage,scoreboardpage};
